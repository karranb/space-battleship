      ...
      <div id="formContainer">
        <div style="display: flex; flex-direction: column; margin-top: 100px; margin-bottom: auto; margin-left: auto; margin-right: auto; justify-content: center; align-items: center;">
          <div style="display: flex; flex-direction: column">
            ...
            <input autocomplete="off" id="nicknameInput" type="text" name="nameField" style="font-size: 16px; background-color: rgba(0,0,0,0.3); color: white; border: 0; border-bottom: 1px solid #00f7fd;font-family: planer; width: 200px; text-align: center" value="Guest">
          </div>
